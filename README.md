...
``` html
<script type="module">
    import * as pkg from '//cdn.pika.dev/duration-timestamp/^2.13.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/duration-timestamp@^2.13.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/duration-timestamp@2.13.0'
</script>
```
