...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/duration-timestamp@^2.21.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/duration-timestamp@^2.21.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/duration-timestamp@2.21.0'
</script>
```
